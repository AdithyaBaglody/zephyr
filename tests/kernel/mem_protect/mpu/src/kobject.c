...
struct k_sem *random_sem_type=NULL;
...
void kobject_test_10(void *p1, void *p2, void *p3)
{
	...
	k_object_access_revoke(&kobject_sem, &kobject_test_10_tid_uninitialized);
	
	/* Test if this has actually taken the requried branch */
...
void kobject_test_15(void *p1, void *p2, void *p3)
{
	...
	k_thread_access_grant(&kobject_test_reuse_3_tid,
			      &kobject_test_reuse_4_tid, &kobject_stack_2, NULL);		
...
/* Create a new thread from user and the user doesnt have access 
...
void kobject_test_17(void *p1, void *p2, void *p3)
{
	...
	k_thread_access_grant(&kobject_test_reuse_1_tid,
			      &kobject_test_reuse_2_tid, &kobject_stack_2, NULL);
...
{
	k_thread_access_grant(&kobject_test_reuse_5_tid,
			      &kobject_test_reuse_6_tid, &kobject_stack_2, NULL);
